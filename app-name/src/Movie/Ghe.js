 ...
 class Ghe extends Component {
    ...
    render() {
      ...
      const vairable = a!==b ? 30 : 20 ;
       ...
       //truethy : number , true , string ,object ,...
      //  faslsy : null, 0 , undefined , '' , nan ,
      ...
      <div>
        {
            ...
            {soGhe}
        </button> : <button onClick={()=>addToCart({soGhe , gia, daDat, hang})} className={`'btn mb-4 ${daDat ? 'btn-warning' : 'btn-secondary'} ${dangChon && 'btn-success'} button-ghe'`}>
            {soGhe}
        </button>
